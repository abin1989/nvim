...
"nnoremap非递归映射
"autocmd自动命令 结构为autocmd 要监听的事件 用于事件过滤的模式(pattern) 要执行的命令
"augroup自动命令组
...
nnoremap <C-F>te :CtrlSFToggle<CR>
inoremap <C-F>te <Esc>:CtrlSFToggle<CR>
...
"nnoremap <leader>pp :GoChannelPeers<Cr>  " 通道信息
...
let g:go_def_mode = 'guru' "跳转到定义的地方
